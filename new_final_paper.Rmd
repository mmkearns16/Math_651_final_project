...
All of our models indicate that population, GDP per capita, being a past, current, or future Olympics host, and being a command economy all correlate positively with higher medal count. Countries that belong to the command economy club on average earn $exp(1.03)=2.801$ times more medals than a similar, democratic country. 
